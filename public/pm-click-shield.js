(function () {
  ...
  try {
    ...
    function getUtm() {
      ...
      return {
        pm_adv: params.get("pm_adv") || "",
        pm_account: params.get("pm_account") || "",
        pm_channel: params.get("pm_channel") || "",
        n_campaign: params.get("n_campaign") || "",
        n_ad_group: params.get("n_ad_group") || "",
        n_group: params.get("n_group") || "",
        n_media: params.get("n_media") || "",
        n_ad: params.get("n_ad") || "",
        n_ad_extension: params.get("n_ad_extension") || "",
        n_keyword: params.get("n_keyword") || "",
        n_keyword_id: params.get("n_keyword_id") || "",
        n_query: params.get("n_query") || "",
        n_match: params.get("n_match") || "",
        n_network: params.get("n_network") || "",
        n_rank: params.get("n_rank") || "",
        n_campaign_type: params.get("n_campaign_type") || "",
        n_mall_id: params.get("n_mall_id") || "",
        n_mall_pid: params.get("n_mall_pid") || "",
        n_ad_group_type: params.get("n_ad_group_type") || "",
